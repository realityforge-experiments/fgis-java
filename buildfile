...
JEE_JARS = [:javax_javaee, :javax_javaee_endorsed, :javax_jsr305, :findbugs_annotations]
GEO_DEPS = [:jeo, :geolatte_geom_jpa, :geolatte_geom, :jts, :slf4j_api, :slf4j_jdk14]
...
define 'fgis' do
  ...
  task 'assets:artifact' => %w(fgis:assets) do
